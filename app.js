...
const playerAgain = document.querySelector('#play-again');

let currentPlayer = 1;

const winningArrayes = [ [0, 1, 2, 3],
[41, 40, 39, 38],
[7, 8, 9, 10],
[34, 33, 32, 31],
[14, 15, 16, 17],
...
function checkBoard() {
  for (let y = 0; y < winningArrayes.length; y++) {
     ...
     const square2 = squares[winningArrayes[y][1]];
     const square3 = squares[winningArrayes[y][2]];
     const square4 = squares[winningArrayes[y][3]];
        ...
        playerAgain.classList.remove('play-again');
